      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {works.map((work, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-[#f0f4ff] to-[#e0e7ff] shadow-md hover:shadow-xl transition duration-300 rounded-xl overflow-hidden"
            >
              <img
                src={work.image}
                alt={work.title}
              ...
              <div className="p-5">
                ...
                <button className="bg-[#1e3a8a] text-white px-4 py-2 rounded-md hover:bg-blue-900 transition">
                  View Details
                </button>
              </div>
            </div>
